...
public sealed class TrackStore
{
    ...
    public List<TrackModel> Queue { get; private set; } = [];
    public List<TrackModel> AvailableTracks { get; private set; } = [];
    public List<PlaylistModel> AvailablePlaylists { get; private set; } = [];
    public List<MusicFolderModel> MusicFolders { get; private set; } = [];
